...
const AuthBg = () => {
        return (
               <section className="col-span-8 bg-[url('https://media.istockphoto.com/id/1138395421/photo/blue-abstract-background-or-texture.jpg?b=1&s=170667a&w=0&k=20&c=3WdlXWR1b6QQpLsNxCthtD6KB2plxys2PNYjreLObSs=')] bg-cover flex items-start flex-col justify-center gap-8 px-24">

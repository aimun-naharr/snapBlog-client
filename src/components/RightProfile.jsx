...
navigate('/login')
        ...
        return (
                <div className='absolute w-96 right-0 bg-white h-screen z-50 opacity-95  top-0 transition-all ease-in-out delay-150'>
                         <ImCross onClick={()=>setOpenRightProfile(false)} className="absolute font-sans text-xl right-4 top-2 cursor-pointer"/>
